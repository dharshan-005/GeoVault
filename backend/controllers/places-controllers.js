...
const createPlace = async (req, res, next) => {
  ...
  res.status(201).json({ place: createdPlace }); // 201 - For something successfully created
};
...
const updatePlace = async (req, res, next) => {
  ...
  const placeId = req.params.pid; // use "pid" because in places-routes.js we have defined it as "/:pid"
